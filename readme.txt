...
La société Logineo “keep IT simple” en collaboration avec Orange Money vous présente Vitepay,
...
The company Logineo "keep IT simple" in collaboration with Orange Money presents Vitepay,

The first online payment service of Mali.
...
1. Upload `vitepay.php` dans le repertoire `/wp-content/plugins/` 
1. Activer le plugin dans le menu « plugins » de wordpress
...
1. Exemple d’interface d’accès au plugin a travers l’interface woo commerce. (/assets/screenshot-1.png)
2. Exemple d’interface de configuration du plugin. (/assets/screenshot-2.png)
3. Exemple de pastille de paiement. (/assets/screenshot-3.png)
4. Exemple d’interface de paiement Vitepay
